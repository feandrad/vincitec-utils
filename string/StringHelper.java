...
public final class StringHelper {
	 ...
	 *
	 * @param arg the UTF-8 String to be encoded
	 * @return a 32-character hexadecimal number
	 * @throws UnsupportedOperationException in the case the VM doesn't support UTF-8 or MD5, you
	 *                                       shouldn't bother catching this exception
	 */
	 ...
	 *
	 * @param arg the raw byte array to be encoded
	 * @return a 32-character hexadecimal number
	 * @throws UnsupportedOperationException in the case MD5 MessageDigest is not supported, you
	 *                                       shouldn't bother catching this exception
	 */
	 ...
	 *
	 * @param inputStream the InputStream to be hashed
	 * @return a 32-character hexadecimal number
	 * @throws IOException when there are problem reading the stream
	 */
	 ...
	 *
	 * @param fis the input stream to be hashed
	 * @return a 32-character hexadecimal number
	 * @throws IOException when InputStream can't be read properly
	 */
	 ...
	 * @throws IOException              when there are problems reading the stream
	 * @throws NoSuchAlgorithmException should not bother to catch this exception
	 */
	 ...
	 * @param multiplier how many times to repeat it
	 ...
	 *
	 * @param input      the string to multiply
	 * @param multiplier how many times to repeat it
	 * @param separator  a separator String to be inserted between repetitions
	 * @return the resulting String
	 */
	 ...
	 * "NULL" is returned.
	 *
	 * @param <T> the type to quote
	 * @param arg the argument to be escaped and quoted
	 ...
	 * @param length the length of the zero-padded long, excluding the
	 *               quotes
	 ...
	 * @param pieces the parts to join
	 ...
	 *
	 * @param glue   the connecting string, for instance a comma
	 * @param pieces the parts to be join
	 ...
	 * @param length how many chars to allow as a max
	 * @return the truncated string (which can be the same of the original
	 * if it was already within length)
	 * @throws IllegalArgumentException if length was negative
	 */
	 ...
	 *
	 * @param str        The input string.
	 * @param startIndex If start is non-negative, the returned string will
	 ...
	 *                   will be returned.
	 * @param length     If length is positive, the string returned will
	 ...
	 *
	 * @param input     the input string
	 * @param maxLength the maximum String length to allow before truncating
	 ...
	 *
	 * @param bogusString the String to recode
